...
const  JobCard= ({ job }) => {
  ...
  return (
    <div className="p-6 w-[370px] mb-4 grid grid-flow-row gap-3 rounded-xl shadow-md bg-white dark:bg-gray-800 hover:shadow-lg transition-all">
      <h2 className="text-xl font-semibold dark:text-white flex items-center gap-2">
        <Work /> {job.title}
        <img src={JobImg} alt="" className="w-12 h-12 rounded-full ml-10" />
      </h2>
