...
const LogoutModal = ({ setVisible }) => { 
    ...
    return (
        <>
            <div id="popup-modal" tabIndex="-1" ref={modalRef} className="block overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-10 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
